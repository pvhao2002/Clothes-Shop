...
namespace ClothesShop.Controllers
{
    public class CartController : Controller
    {
        ...
        {
            string vnp_Returnurl = "https:44315/Thank/Index";
            ...
            vnpay.AddRequestData("vnp_CreateDate", o.created_at.Value.ToString("yyyyMMddHHmmss"));
            ...
            vnpay.AddRequestData("vnp_TxnRef", o.order_id.ToString());
            vnpay.AddRequestData("vnp_ExpireDate", DateTime
                .Now.AddMinutes(Convert.ToDouble("15")).ToString("yyyyMMddHHmmss"));
